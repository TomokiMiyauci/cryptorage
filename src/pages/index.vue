  ...
  <div>
    <v-toolbar flat>
      <v-toolbar-title>
        <v-avatar size="30px">
          <v-img
            :src="require('~/assets/logos/cryptorage.png')"
            alt="avatar"
          ></v-img>
        </v-avatar>
        <span class="grey--text">CRYPTO</span>
        <span class="orange--text">RAGE</span>
      </v-toolbar-title>
    </v-toolbar>

    <v-parallax
      :src="require('~/assets/logos/crypto-currency.jpg')"
      height="600"
    >
      <v-layout column align-center justify-center class="white--text">
        ...
        <h1 class="white--text mb-2 display-1 text-xs-center">Cryptorage</h1>
        <div class="subheading text-xs-center">
          Crypto Asset Arbitrage Tool for Humansy
        </div>

        <v-btn class="orange mt-5" dark large href="/markets"
          >Get Started</v-btn
        >
      </v-layout>
    </v-parallax>
